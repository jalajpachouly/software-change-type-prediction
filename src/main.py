...
Original file is located at
    https://colab.research.google.com/drive/1VULX5MCg1ltbnYYlbEjcE7hzSP7gmLkc
"""
...
2. Training Data Distribution Before SMOTE (Unbalanced)
3. Training Data Distribution After SMOTE (Balanced)
4. BERT Training Data Distribution Before Oversampling (Unbalanced)
5. BERT Training Data Distribution After Oversampling (Balanced)
6. Evaluation Metrics Box Plot - Balanced
7. Evaluation Metrics Box Plot - Unbalanced
8. Evaluation Metrics Bar Plot - Balanced
9. Evaluation Metrics Bar Plot - Unbalanced
...
plt.tight_layout()
plt.savefig('output/train_dist_unbal.png')
plt.show()
...
plt.xticks(ticks=range(len(label_encoder.classes_)), labels=label_encoder.classes_, rotation=45)
plt.tight_layout()
plt.savefig('output/train_dist_bal.png')
plt.show()
...
plot_metrics_box(metrics_unbalanced, 'unbal')
plot_metrics_bar(metrics_unbalanced, 'unbal')

# Generate plots for balanced data
plot_metrics_box(metrics_balanced, 'bal')
plot_metrics_bar(metrics_balanced, 'bal')
